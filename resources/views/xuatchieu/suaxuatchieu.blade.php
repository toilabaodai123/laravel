                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Sửa xuất chiếu</h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form action="{{$dsxuatchieu->id}}" method="post">
											@csrf
											@method('put')
                                            <div class="form-group mb-3">
												@foreach($dsphim as $phim)
                                                <label for="simpleinput">Tên phim</label>
                                                <input disabled name="phim" type="text" id="simpleinput" value="{{$phim->tenphim}}"class="form-control">
												<select hidden name="phim" class="form-control" id="example-select" style="width:100px">
